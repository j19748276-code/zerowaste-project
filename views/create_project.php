        ...
        <form id="createProjectForm" action="index.php?action=storeProject" method="POST" enctype="multipart/form-data" novalidate autocomplete="off">
            ...
            <div class="space-y-6">
                <div>
                    ...
                    <div class="relative">
                        <input type="text" id="titre" name="titre" placeholder="Ex: Lampe à partir d'une bouteille" class="w-full px-4 py-2 pr-10 border border-gray-300 rounded-lg focus:ring-green-500 focus:border-green-500" required minlength="3" value="<?= escAttr($_POST['titre'] ?? '') ?>" aria-describedby="titreHelp">
